...
def main():
    ...
    parser.add_argument('--checkpoint_generator_file', default='/home/malradhi/AutoVocoder/g_00210000')
    parser.add_argument('--checkpoint_encoder_file',default='/home/malradhi/AutoVocoder/e_00210000')
    parser.add_argument('--input_training_file',default='/home/malradhi/AutoVocoder/LJSpeech-1.1/training.txt')
    parser.add_argument('--data_path', default='/home/malradhi/AutoVocoder')
    parser.add_argument('--input_wavs_dir',default='/home/malradhi/AutoVocoder/test')
    a = parser.parse_args()
